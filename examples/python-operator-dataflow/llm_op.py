...
class Operator:
    ...
    def ask_llm(self, prompt):
        ...
        """
        Generate a text completion from the language model for the given prompt.
        
        Parameters:
            prompt (str): Full input prompt sent to the model.
        
        Returns:
            str: Generated text produced by the model with the original prompt trimmed from the start.
        """
